...
class Party(Base):
    ...
    host_user = relationship("User", backref="hosted_parties")
    activity = relationship("Activities", backref="parties")
    location = relationship("Location", backref="parties")

    players = relationship("PartyPlayer", back_populates="party", cascade="all, delete-orphan")
